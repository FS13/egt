...
import org.eclipsescout.egt.client.configuration.EgtConfigurationTablePage;
...
public class StandardOutline extends AbstractExtensibleOutline {
  ...
  protected void execCreateChildPages(List<IPage> pageList) throws ProcessingException {
    ...
    EgtConfigurationTablePage egtConfigurationTablePage = new EgtConfigurationTablePage();
    pageList.add(egtConfigurationTablePage);
  }
}
