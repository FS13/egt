...
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.EdgesTabBox;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.EdgesTabBox.EdgesTableField.Table.EgtGraphWeightedDirectedEdgeColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.EdgesTabBox.EdgesTableField.Table.FromColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.EdgesTabBox.EdgesTableField.Table.ScaledWeightColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.EdgesTabBox.EdgesTableField.Table.ToColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.EdgesTabBox.EdgesTableField.Table.WeightColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.VerticesTabBox;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.VerticesTabBox.VerticesTableField.Table.EgtGraphVertexColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.VerticesTabBox.VerticesTableField.Table.IDColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.ConfigurationBox.VerticesTabBox.VerticesTableField.Table.SpeciesColumn;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.GraphSvgField;
import org.eclipsescout.egt.client.graph.EgtGraphDetailForm.MainBox.GroupBox.GraphSvgSourceField;
          ...
          public class VertexConfigurationBox extends AbstractGroupBox {
            ...
            private class AbstractVertexConfigurationButton extends AbstractButton {
              ...
              protected void execClickAction() throws ProcessingException {
                ...
                if (getVerticesTableField().getTable().getSelectedRowCount() == 0) {
                  MessageBox.showOkMessage(TEXTS.get("EGTFS"), null, TEXTS.get("PleaseSelectVertex"));
                }
                else {
            ...
            public class LeftButton extends AbstractVertexConfigurationButton {
              ...
              public List<IKeyStroke> getContributedKeyStrokes() {
                ...
                keyStrokes.add(new KeyStroke("a"));
                return keyStrokes;
              }
            }
            ...
            public class UpButton extends AbstractVertexConfigurationButton {
              ...
              public List<IKeyStroke> getContributedKeyStrokes() {
                List<IKeyStroke> keyStrokes = new ArrayList<IKeyStroke>();
                keyStrokes.add(new KeyStroke("w"));
                return keyStrokes;
              }
            }
            ...
            public class RightButton extends AbstractVertexConfigurationButton {
              ...
              public List<IKeyStroke> getContributedKeyStrokes() {
                List<IKeyStroke> keyStrokes = new ArrayList<IKeyStroke>();
                keyStrokes.add(new KeyStroke("d"));
                return keyStrokes;
              }
            }
                ...
                protected void execCompleteEdit(ITableRow row, IFormField editingField) throws ProcessingException {
                  ...
                  if (!CompareUtility.equals(fromId, null) && !CompareUtility.equals(toId, null)) {
                    ...
                    for (ITableRow r : getEdgesTabBox().getEdgesTableField().getTable().getRows()) {
                      if (CompareUtility.equals(getEdgesTabBox().getEdgesTableField().getFromColumn().getValue(r), fromId)) {
                        list.add(r);
                    ...
                    for (ITableRow r : list) {
                      ...
                      EgtGraphWeightedDirectedEdge edge = getEdgesTableField().getEgtGraphWeightedDirectedEdgeColumn().getValue(r);
                      edge.setWeight(weight);
                      changeEdge(edge);
                    }
                  }
                  else {
                    MessageBox.showOkMessage(TEXTS.get("EGTFS"), null, TEXTS.get("SelectVerticesFirst"));
                  }
                }
              ...
              public class NewMenu extends AbstractExtensibleMenu {
                ...
                public void execAction() throws ProcessingException {
                  ...
                  if (form.isFormStored()) {
                    ITableRow row = getTable().createRow();
                    EgtGraphWeightedDirectedEdge edge = new EgtGraphWeightedDirectedEdge(getGraph().getVertexById(form.getFromField().getValue()), getGraph().getVertexById(form.getToField().getValue()), 0);
                    row.setCellValue(getEdgesTableField().getEgtGraphWeightedDirectedEdgeColumn().getColumnIndex(), edge);
                    addEdge(edge);
                    getTable().addRow(row);
                  }
                }
