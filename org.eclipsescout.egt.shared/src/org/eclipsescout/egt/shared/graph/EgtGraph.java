...
public class EgtGraph {
  ...
  private void updateViewBox(EgtGraphVertex vertex) {
    ...
    setViewBoxRange(Math.max(getViewBoxRange(), Math.max(x + radiusPlus + getBoundary(), y + radiusPlus + getBoundary()) - Math.min(getViewBoxStartX(), getViewBoxStartY())));

  }

  public String getSvgString() {
    String svgText = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>" + "\n"
        + "<svg width=\"1000\" height=\"1000\" viewBox=\"" + getViewBoxStartX() + " " + getViewBoxStartY() + " " + getViewBoxRange() + " " + getViewBoxRange() + "\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" contentScriptType=\"text/ecmascript\" zoomAndPan=\"magnify\" contentStyleType=\"text/css\" version=\"1.1\" xml:space=\"preserve\" preserveAspectRatio=\"xMidYMid meet\">" + "\n"
