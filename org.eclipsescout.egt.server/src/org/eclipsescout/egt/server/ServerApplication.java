package org.eclipsescout.egt.server;
 ...
 * org.eclipse.equinox.http.jetty.context.path=/egt_server
 ...
 * eclipse.product=org.eclipsescout.egt.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("egt server initialized");
    return EXIT_OK;
  }
